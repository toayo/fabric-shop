    ...
    <div className="container pb-20">
      ...
      {items.length === 0 ? (
        <div className="mt-10 rounded-3xl bg-white p-8 text-center shadow-sm">
          ...
          <Link
            href="/shop"
            className="mt-4 inline-flex rounded-full bg-ember px-6 py-3 text-sm font-semibold text-white"
          >
            Browse fabrics
          </Link>
        </div>
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                      <label className="text-xs uppercase text-cocoa/60">
                        ...
                        <input
                          ...
                          className="ml-2 w-20 rounded-full border border-cocoa/20 px-2 py-1 text-xs"
                        />
                      </label>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm">
            ...
            <Link
              href="/checkout"
              className="mt-6 inline-flex w-full justify-center rounded-full bg-ember px-6 py-3 text-sm font-semibold text-white"
            >
              Proceed to Checkout
            </Link>
          </div>
