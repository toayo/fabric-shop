...
export default function QuantityStepper({ value, onChange }: QuantityStepperProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <motion.button
        whileTap={{ scale: 0.95 }}
        className="rounded-full border border-cocoa/20 px-3 py-1 text-lg transition hover:border-brand/40 hover:text-brand"
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          className="mt-1 w-28 rounded-full border border-cocoa/20 bg-white px-3 py-2 text-sm focus:border-brand/40 focus:outline-none focus:ring-2 focus:ring-brand/20"
        />
