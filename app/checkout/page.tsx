  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        ...
        className="w-full rounded-full bg-brand px-6 py-3 text-sm font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-brand-dark disabled:opacity-60"
      >
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-3xl bg-white p-6 shadow-sm">
          <div className="flex items-center gap-3 text-xs uppercase text-cocoa/50">
            <span className={step >= 1 ? "text-brand" : ""}>Cart summary</span>
            <span>→</span>
            <span className={step >= 2 ? "text-brand" : ""}>Customer info</span>
            <span>→</span>
            <span className={step >= 3 ? "text-brand" : ""}>Payment</span>
          </div>
          <AnimatePresence mode="wait">
            {step === 1 && (
              ...
              >
                ...
                <button
                  onClick={() => setStep(2)}
                  className="mt-4 rounded-full bg-brand px-6 py-3 text-sm font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-brand-dark"
                >
                  Continue
                </button>
              </motion.div>
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-full border border-cocoa/20 px-4 py-3 text-sm focus:border-brand/40 focus:outline-none focus:ring-2 focus:ring-brand/20"
                  />
                </div>
                <div>
